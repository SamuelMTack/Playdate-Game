...
function playdate.file:seek(offset, whence) end
...
function playdate.graphics.animation.loop.new(interval, imageTable) end
...
function playdate.graphics.font:drawText(text, x, y, width, height) end
...
function playdate.graphics.drawText(text, x, y, width, height) end
function playdate.graphics.drawLocalizedText(key, x, y, language) end
...
function playdate.network.setEnabled(flag, _function) end
function playdate.network.getStatus() end
function playdate.network.http.new(server, port) end
function playdate.network.http.requestAccess(server) end
...
function playdate.network.http:query(method, path, headers) end
function playdate.network.http:post(path, headers) end
...
function playdate.network.tcp.new(server, port, usessl) end
function playdate.network.tcp.requestAccess(server) end
